...
local Utility = {}
local Objects = {}
function Cheese:DraggingEnabled(frame, parent)
...
function Cheese.CreateLib(AYName, themeList)
    ...
    local selectedTab 
    AYName = AYName or "Library"
    table.insert(Cheese, AYName)
    for i,v in pairs(game.CoreGui:GetChildren()) do
        if v:IsA("ScreenGui") and v.Name == AYName then
            v:Destroy()
        end
    end
    ...
    Cheese:DraggingEnabled(MainHeader, Main)
    ...
    function Cheese:ChangeColor(prope,color)
